...
lazy val sharedSettings = Seq(
  ...
  scalacOptions ++= (if (isSnapshot.value) Seq.empty else Seq({
        ...
        val g = "https://raw.githubusercontent.com/jokade/sbt-electron"
...
lazy val plugin = project
  ...
  .settings(
    ...
    addSbtPlugin("de.surfice" % "sbt-node" % Version.sbtNode)
  )
...
lazy val publishingSettings = Seq(
  ...
  pomExtra := (
    <url>https://github.com/jokade/sbt-electron</url>
    <licenses>
      <license>
    ...
    <scm>
      <url>git@github.com:jokade/sbt-electron</url>
      <connection>scm:git:git@github.com:jokade/sbt-electron.git</connection>
    </scm>
    <developers>
      <developer>
        <id>jokade</id>
